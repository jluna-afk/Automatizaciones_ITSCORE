...
class TestCrearRelacionBeneficiario(unittest.TestCase):
    ...
    def test_crear_relacion_beneficiario(self):
        ...
        time.sleep(1)
        validar_mensaje_snackbar_async_guardar(driver, "//div[@class='mb-3 form-actions']//button[@type='button'][normalize-space()='Guardar']", "Relación de beneficiario modificada con éxito")
