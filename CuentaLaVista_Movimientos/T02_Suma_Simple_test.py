...
class TestMovimientosCuentaVista(unittest.TestCase):
    ...
    def test_CV_suma_simple(self):
        ...
        print("🔵 INGRESO AL MODULO DE MOVIMIENTOS DE CUENTA A LA VISTA")
        ...
        seleccionar_opcion_ng_select_js(driver, "ACREDITACION INICIAL")
        print("🔵 SELECCION DE OPERACION")

        find_and_send_keys(driver, (By.XPATH, "//input[@formcontrolname='concepto']"), "test suma simple")
