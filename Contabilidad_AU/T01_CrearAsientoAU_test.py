...
from Pages.base_page import (
    find_and_send_keys_with_scroll,
...
class TestAsientosAutomaticos(unittest.TestCase):
    ...
    def test_crear_asiento_automatico(self):
        ...
        find_and_send_keys_with_scroll(driver, (By.XPATH, "//input[@placeholder='Usuario']"), "joaquinluna")
        find_and_send_keys_with_scroll(driver, (By.XPATH, "//input[@placeholder='Clave']"), "joaquin")
        ...
        seleccionar_opcion_ng_select_with_filter(driver, (By.XPATH, "//ng-select[@class='form-select ng-select-custom ng-select-searchable ng-select ng-select-single ng-untouched ng-pristine ng-invalid']//input[@type='text']"), "Banco")
        print("🔵 SELECCION OPERATORIA")

        seleccionar_opcion_ng_select_with_filter(driver, (By.XPATH, "//ng-select[@formcontrolname='operacion_id']//input[@type='text']"), "PAGO SUELDOS")
        print("🔵 SELECCION OPERACION")

        seleccionar_opcion_ng_select_with_filter(driver, (By.XPATH, "//ng-select[@formcontrolname='linea_id']//input[@type='text']"), "1 BANCO BBVA ARGENTINA S.A.")
        print("🔵 SELECCION LINEA BANCO")

        find_and_send_keys_with_scroll(driver, (By.XPATH, "//input[@class='form-control form-control-sm text-left pl-2']"), "10072025")
        ...
        find_and_send_keys_with_scroll(driver, (By.XPATH, "//input[@id='numeroCuenta']"), "1.1.1.01.01.01")
        ...
        find_and_send_keys_with_scroll(driver, (By.XPATH, "//tr[@class='ng-invalid ng-touched ng-dirty']//input[@id='numeroCuenta']"), "1.1.1.01.02.01")
