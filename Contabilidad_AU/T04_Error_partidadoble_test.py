...
class TestAsientosAutomaticos(unittest.TestCase):
    ...
    def test_error_partida_doble(self):
        driver = self.driver
        ...
        find_and_click_with_scroll(driver, (By.XPATH, "//tbody/tr[2]/td[5]/div[1]/label[1]/span[1]"))
        ...
        validar_mensaje_snackbar(driver, "Error de partida doble: Debe (2) no coincide con Haber (0).") 
