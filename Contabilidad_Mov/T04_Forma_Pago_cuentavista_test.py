...
class TestContabilidadMovimiento(unittest.TestCase):
    ...
    def testcontabilidad_forma_pago_cuentavista(self):
        driver = self.driver
        ...
        seleccionar_opcion_ng_select(driver, "491")
        ...
        seleccionar_opcion_ng_select(driver, "PROV. COMBUSTIBLE")
        print("🔵 SELECCION CUENTA DESTINO PROV. COMBUSTIBLE")
